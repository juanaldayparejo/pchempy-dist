...
!============================================================================================================================
    ...
    subroutine load_reactions(nlay,ngas,gasID,isoID,h,P,T,N,nitrogen_chemistry,c13_chemistry,o18_chemistry,photolysis,&
        ...
        !Local 
        double precision, dimension(nlay) :: a001, a002, a003                    !oxygen reactions

        double precision, dimension(nlay) :: b001, b002, b003, b004, b005, b006  !o1d reactions

        double precision, dimension(nlay) :: c001, c002, c003, c004, c005, c006, &  !hydrogen reactions
                                             c007, c008, c009, c010, c011, c012, &
                                             c013, c014, c015, c016, c017, c018
        
        double precision, dimension(nlay) :: d001, d002, d003, d004, d005, d006, &  !hydrogen reactions
