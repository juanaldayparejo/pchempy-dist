...
for itscale in range(ntscale):
    ...
    while converged==False:
        ...
        Nnew,ztime,dtcur = pmodel.mars_c13_converge.converge_model_rosenbrock(hlay,Play,Tlay,Nlay,gasID,isoID,mmol,A,s,B,typelbc,valuelbc,typeubc,valueubc,fix_species,sza,tauvis,dist_sun,dtmin,dtmax)
