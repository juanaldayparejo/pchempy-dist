...
MODULE mars_c13_converge

    real, parameter :: rtol = 0.0001             !relative tolerance
    real, parameter :: atol = 0.05             !absolute tolerance
    integer, parameter :: max_iter = 5000  !maximum number of iterations
    double precision :: mindt = 0.0001          !minimum timestep
...
!==============================================================================================================================================
    ...
    subroutine converge_model_rosenbrock(nlay,ngas,h,P,T,N,gasID,isoID,mmol,A,s,B,&
        ...
        use chemistry
        use photolysis
        use mars_c13_diffusion
        use mars_c13_chemical_network
